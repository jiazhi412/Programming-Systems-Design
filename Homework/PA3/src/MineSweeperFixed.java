...
public class MineSweeperFixed {
   ...
   private static boolean[][] TwoMineField = 
	      {{false, false, false, false}, 
	       {false, false, false, false}, 
	       {false, false, true, false},
	       {false, true, false, false}};

   private static boolean[][] ThreeMineField = 
	      {{false, false, false, false}, 
	       {false, false, false, false}, 
	       {false, true, true, false},
	       {false, true, false, false}};
   ...
   public static void main(String[] args) {
      ...
      GameBoardPanel gameBoard = new GameBoardPanel(new VisibleField(new MineField(ThreeMineField)));
