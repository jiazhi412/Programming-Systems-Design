...
public class After7Tester {
   ...
   public static void after7(LinkedList<Integer> list) {
      ...
      // remove the element after 7
      ListIterator<Integer> iter_last = list.listIterator(list.size());      
      while(iter_last.previous() != 7) {
         iter_last.remove();
      }
      return;
   }
    ...
    */
   private static void testAfter7(String listString, String expectedResult) {
